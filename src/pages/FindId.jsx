    ...
    <div>
      ...
      <div style={box2}>
        ...
        <div style={{ display: 'flex', justifyContent: 'center' }}>
          <span className='findTitle'>아이디 찾기</span>
          <Link to="/findpw" className='hideTitle'>비밀번호 찾기</Link>
        </div>
        ...
        <div>
         ...
         <Form.Group className='mb-3' controlId='formBasicID'>
          ...
          {/* 확인 버튼 */}
          <Button variant='primary' style={{ backgroundColor: '#FFC9C9', borderColor: '#FFC9C9', color: 'gray',
                                              width: '200px',}}>
            확인
          </Button>
          </div>
